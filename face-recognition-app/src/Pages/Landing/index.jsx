  ...
  return (
    <div>
        ...
        <div className="first-section-inside">
          <div className="first-section-content">
            <div className="first-section-contents">
              <h2>
                Facial Recognition <br /> App for Schools
              </h2>
              <p>
                Reflex ID provides schools a more <br /> secured verification
                platform for <br /> parents and guardians come over <br /> to
                pick up their wards from schools
              </p>
      ...
      <section className="services" id="services">
        ...
        <h5>
          We provide you the best options and services to suit your convenience
          while ensuring <br /> adequate safety measures are in check.
        </h5>
        ...
        <div className="features-inside">
          ...
          <div className="features-content">
            <div className="features-contents">
              ...
              <p>
                Reflex ID possses the facial scab feature <br /> which uses the
                3D face unlocking feature.
              </p>
        ...
        <div className="Mobile-app-inside">
          <div className="Mobile-app-content">
            <div className="Mobile-app-contents">
              <h1>
                Worry less and stay security conscious with our mobile app
              </h1>
              <p>
                If you are ever concerned about your child's activities while in
                school, explore our mobile-friendly app tohelp you learn how to
                keep track.
              </p>
        ...
        <div className="Testimonials-box">
          ...
          <div className="Testimonials-contents">
            <div className="Testimonials-inside">
              <img
                src="https://miro.medium.com/max/2000/1*CadPWIt6C8Ef0k5u9TOFyw.jpeg"
                alt=""
              />
            ...
            <p>
              "App is easy to navigate and I feel safer knowing that I am in
              charge of authorizing and confirming who comes to pick up my son."
            </p>
          </div>
        </div>
        <div>
          {/* <!-- Next and previous buttons --> */}
          <a className="testimonials-prev" href="/testimonials">
            <img src={left} alt="" />
          </a>
          {/* <!-- The dots/circles --> */}
